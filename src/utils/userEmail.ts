export const otpEmail = (otp: string, name: string) => {
    ...
    <body>
      <div class="container">
        <div>
          <a href="#" class="logo">BEDBLISS</a>
        </div>
        <p>Hi,${name}</p>
        <p>Welcome to BedBliss. Use the following OTP to complete your Sign Up procedures. OTP is valid for 2 minutes</p>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" style="padding: 40px 30px;">
                                ...
                                <p style="text-align: center;">
                                    <a href="https://bedbliss.netlify.app/auth/resetPassword/${verificationCode}" style="display: inline-block; padding: 12px 24px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
                                </p>
